...
public class Batalha {
    ...
    public void rodarBatalha(Baralho baralho, Heroi heroi, Inimigo inimigo, Scanner scanner){
        ...
        while (heroi.getVida() > 0 && inimigo.getVida() > 0) {
            //Turno do heroi
            turnoDoHeroi(heroi, inimigo, baralho, scanner);
            // Fim do turno do heroi

            // Turno do inimigo
            turnoDoInimigo(inimigo, heroi, defesaInimigo);
    ...
    private void imprimirMenu(Baralho baralho, Heroi heroi, Inimigo inimigo){
    ...
    private void turnoDoInimigo(Inimigo inimigo, Heroi heroi, int defesaInimigo){
    ...
    private void turnoDoHeroi(Heroi heroi, Inimigo inimigo, Baralho baralho, Scanner scanner){
